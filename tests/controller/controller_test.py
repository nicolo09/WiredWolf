...
class ServiceManagerTest(unittest.TestCase):
    ...
    def test_service_discovery(self):
        ...
        self.service_manager.get_service_browser(
            listener=self.service_manager.get_service_listener(
...
class LobbyBrowserTest(unittest.TestCase):
    ...
    def test_lobby_publish_and_discovery(self):  # TODO: Flaky test, sometimes fails
        ...
        self.lobby_browser.publish_lobby("TestLobby", DEFAULT_SERVER_PORT)
        ...
        self.assertTrue(
            discovered_lobbies[0].startswith("TestLobby"), "No lobbies were discovered."
        )
